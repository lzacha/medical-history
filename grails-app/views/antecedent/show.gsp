	...
	<body>
		...
		<div id="show-antecedent" class="content scaffold-show" role="main">
			...
			<ol class="property-list antecedent">
				...
				<g:if test="${antecedentInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="antecedent.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${antecedentInstance}" field="description"/></span>
