			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'antecedent.description.label', default: 'Description')}" />
				...
				<g:each in="${antecedentInstanceList}" status="i" var="antecedentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${antecedentInstance.id}">${fieldValue(bean: antecedentInstance, field: "description")}</g:link></td>
