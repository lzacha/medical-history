	...
	<body>
		...
		<div id="show-treatment" class="content scaffold-show" role="main">
			...
			<ol class="property-list treatment">
				...
				<g:if test="${treatmentInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="treatment.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${treatmentInstance}" field="description"/></span>
