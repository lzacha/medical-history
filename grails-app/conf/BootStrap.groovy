...
class BootStrap {
    ...
    def setDevelopmentData(){
       ...
       //def mu1 = new MeasurementUnit(descriptionUnit:"Centimetros cuadrados", unit:"cm2")
        ...
        def st6 = new StudyTypes(description:"C�mara Gamma")
		...
		def st10 = new StudyTypes(description:"ECO Doppler Cardiaco")
		def st11 = new StudyTypes(description:"MAPA Resumen")
		...
		def st15 = new StudyTypes(description:"Variabilidad de la tensi�n arterial y Sensibilidad de Barorreflejo")
